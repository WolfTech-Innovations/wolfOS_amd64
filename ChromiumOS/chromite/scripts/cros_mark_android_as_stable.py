...
_ARC_BUCKET_URL = "gs://chromeos-arc-images/builds"

# The bucket hosting runtime artifacts generated by arc.DataCollector.
...
def GetParser():
    ...
    parser.add_argument(
        "--arc_bucket_url", default=_ARC_BUCKET_URL, type="gs_path"
    )
