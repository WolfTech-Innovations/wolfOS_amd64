...
_KNOWN_SYMLINKS = [
    # These are symlinks generated by bazel itself.
    "bazel-bin",
    "bazel-out",
    "bazel-src",
    "bazel-testlogs",
    "@portage",
    # This is usually discouraged because opening vscode at src/ is very slow.
    # However, this corresponds to the bazel workspace, and when combined with
    # directory exclusions, works just fine.
    ".vscode",
]
