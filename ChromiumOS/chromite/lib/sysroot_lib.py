...
class Sysroot:
    ...
    def InstallMakeConfBoard(
        ...
        binhost_overrides: Optional[List[str]] = None,
    ) -> None:
        ...
        Args:
            ...
            binhost_overrides: List of binhosts to use instead of the committed
                board-specific binhosts.
        """
        ...
        binhost_conf = self.GenerateBinhostConf(
            ...
            binhost_overrides=binhost_overrides,
        )
        osutils.WriteFile(
...
# Source make.conf from each overlay."""
    ...
    def GenerateBinhostConf(
        ...
        elif binhost_overrides:
            binhosts = " ".join(binhost_overrides)
            config = [
                f"""
# The LOOKUP_SERVICE_BINHOST is an override of the committed FULL and POSTSUBMIT
# binhosts that are committed to the tree.
LOOKUP_SERVICE_BINHOST="{binhosts}"
