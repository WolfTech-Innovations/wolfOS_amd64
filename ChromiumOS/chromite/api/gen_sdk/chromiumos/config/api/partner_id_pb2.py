...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'chromiumos.config.api.partner_id_pb2', _globals)
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z(go.chromium.org/chromiumos/config/go/api'
  _globals['_PARTNERID']._serialized_start=65
  _globals['_PARTNERID']._serialized_end=91
