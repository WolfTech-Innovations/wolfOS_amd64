...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'chromiumos.config.api.component_package_pb2', _globals)
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z(go.chromium.org/chromiumos/config/go/api'
  _globals['_COMPONENTPACKAGE']._serialized_start=112
  _globals['_COMPONENTPACKAGE']._serialized_end=1224
