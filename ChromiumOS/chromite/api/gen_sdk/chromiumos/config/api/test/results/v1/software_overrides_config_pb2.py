...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'chromiumos.config.api.test.results.v1.software_overrides_config_pb2', _globals)
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z@go.chromium.org/chromiumos/config/go/api/test/results/v1;results'
  _globals['_SOFTWAREOVERRIDESCONFIG']._serialized_start=165
  _globals['_SOFTWAREOVERRIDESCONFIG']._serialized_end=256
