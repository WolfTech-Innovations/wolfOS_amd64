...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'chromiumos.config.api.test.results.v1.software_config_pb2', _globals)
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z@go.chromium.org/chromiumos/config/go/api/test/results/v1;results'
  _globals['_SOFTWARECONFIG']._serialized_start=253
  _globals['_SOFTWARECONFIG']._serialized_end=1140
  _globals['_SOFTWARECONFIG_CHROMEOS']._serialized_start=771
  _globals['_SOFTWARECONFIG_CHROMEOS']._serialized_end=1014
  _globals['_SOFTWARECONFIG_OS']._serialized_start=1016
  _globals['_SOFTWARECONFIG_OS']._serialized_end=1140
