...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'chromiumos.config.api.schedqos_config_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  DESCRIPTOR._serialized_options = b'Z(go.chromium.org/chromiumos/config/go/api'
  _SCHEDQOSCONFIG._serialized_start=103
  _SCHEDQOSCONFIG._serialized_end=1279
  _SCHEDQOSCONFIG_THREADCONFIG._serialized_start=188
  _SCHEDQOSCONFIG_THREADCONFIG._serialized_end=475
  _SCHEDQOSCONFIG_CONFIGSET._serialized_start=478
  _SCHEDQOSCONFIG_CONFIGSET._serialized_end=1184
  _SCHEDQOSCONFIG_CPUSETCGROUP._serialized_start=1186
  _SCHEDQOSCONFIG_CPUSETCGROUP._serialized_end=1279
