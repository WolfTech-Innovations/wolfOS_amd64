...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _COMMONCONFIG_CROSFIRMWAREUPDATECONFIG_CROSSLECTOR._serialized_end=991
  _COMMONCONFIG_RDBCONFIG._serialized_start=1026
  _COMMONCONFIG_RDBCONFIG._serialized_end=1064
